...
## 尾训探针 (2026-09-10 21:xx, 4090)
- last.pth + 恒定 lr 5e-5 + 官方增强, 新增 5ep: AP50-95 全部 0.495-0.496 (Δ+0.001 噪声)
- 结论: 当前配方下 S 已到表征收敛点, 末段续训无可提取余量
- 对 132ep 的修正期望: 官方配方差异在中段高 lr 探索, 期望增益 +0-1pp (原估 +2-3pp 下修)
